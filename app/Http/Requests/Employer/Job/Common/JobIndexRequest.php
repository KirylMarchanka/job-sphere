...
namespace App\Http\Requests\Employer\Job\Common;
...
class JobIndexRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'salary_from' => ['sometimes', 'nullable', 'integer', 'numeric', 'lte:salary_to'],
            'salary_to' => ['sometimes', 'nullable', 'integer', 'numeric', 'gte:salary_from'],
